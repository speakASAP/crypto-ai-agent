# Copilot Compatibility Instructions - `crypto-ai-agent`
...
Repository: [https://github.com/speakASAP/crypto-ai-agent](https://github.com/speakASAP/crypto-ai-agent)
Authoritative checkout: `/home/ssf/Documents/Github/crypto-ai-agent` on `alfares`.
