# Copilot Instructions — `crypto-ai-agent`
...
- **Authoritative path**: `/home/ssf/Documents/Github/crypto-ai-agent` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/crypto-ai-agent.git`, branch `main`.
