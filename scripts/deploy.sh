#!/bin/bash
# crypto-ai-agent Application Deployment Script
# Usage: ./scripts/deploy.sh
#
# This script deploys the crypto-ai-agent application to production using the
...
echo -e "${BLUE}╔════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║     crypto-ai-agent Application - Production Deployment            ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
if [ $DEPLOY_EXIT_CODE -eq 0 ]; then
    ...
    echo -e "${GREEN}╚══════════════════════════════════════════════════════════════════════╝${NC}"
    echo ""
    echo "The crypto-ai-agent application has been deployed using blue/green deployment."
